...
type Order struct {
	...
	Items       []string `protobuf:"bytes,2,rep,name=items,proto3" json:"items,omitempty"` // repeated is used to represent the fields that can be repeated any number of items
...
func (x *Order) Reset() {
	*x = Order{}
	if protoimpl.UnsafeEnabled {
		mi := &file_datafiles_proto_msgTypes[0]
...
func (*Order) Descriptor() ([]byte, []int) {
	return file_datafiles_proto_rawDescGZIP(), []int{0}
}
...
func (x *CombinedShipment) Reset() {
	*x = CombinedShipment{}
	if protoimpl.UnsafeEnabled {
		mi := &file_datafiles_proto_msgTypes[1]
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		ms.StoreMessageInfo(mi)
	}
}
...
func (*CombinedShipment) Descriptor() ([]byte, []int) {
	return file_datafiles_proto_rawDescGZIP(), []int{1}
}
...
var File_datafiles_proto protoreflect.FileDescriptor

var file_datafiles_proto_rawDesc = []byte{
	0x0a, 0x0f, 0x64, 0x61, 0x74, 0x61, 0x66, 0x69, 0x6c, 0x65, 0x73, 0x2e, 0x70, 0x72, 0x6f, 0x74,
...
var (
	file_datafiles_proto_rawDescOnce sync.Once
	file_datafiles_proto_rawDescData = file_datafiles_proto_rawDesc
)

func file_datafiles_proto_rawDescGZIP() []byte {
	file_datafiles_proto_rawDescOnce.Do(func() {
		file_datafiles_proto_rawDescData = protoimpl.X.CompressGZIP(file_datafiles_proto_rawDescData)
	})
	return file_datafiles_proto_rawDescData
}

var file_datafiles_proto_msgTypes = make([]protoimpl.MessageInfo, 2)
var file_datafiles_proto_goTypes = []interface{}{
	(*Order)(nil),                  // 0: ecommerce.Order
	(*CombinedShipment)(nil),       // 1: ecommerce.CombinedShipment
	(*wrapperspb.StringValue)(nil), // 2: google.protobuf.StringValue
}
var file_datafiles_proto_depIdxs = []int32{
...
func init() { file_datafiles_proto_init() }
func file_datafiles_proto_init() {
	if File_datafiles_proto != nil {
		return
	}
	if !protoimpl.UnsafeEnabled {
		file_datafiles_proto_msgTypes[0].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*Order); i {
			case 0:
				return &v.state
			case 1:
		...
		file_datafiles_proto_msgTypes[1].Exporter = func(v interface{}, i int) interface{} {
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: file_datafiles_proto_rawDesc,
			NumEnums:      0,
			NumMessages:   2,
			NumExtensions: 0,
			NumServices:   1,
		},
		GoTypes:           file_datafiles_proto_goTypes,
		DependencyIndexes: file_datafiles_proto_depIdxs,
		MessageInfos:      file_datafiles_proto_msgTypes,
	}.Build()
	File_datafiles_proto = out.File
	file_datafiles_proto_rawDesc = nil
	file_datafiles_proto_goTypes = nil
	file_datafiles_proto_depIdxs = nil
}
